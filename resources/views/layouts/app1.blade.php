    ...
    <div id="amazingslider-wrapper-1" style="display:block;position:relative;max-width:80%;margin:51px auto 64px;">
        <div id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
            <ul class="amazingslider-slides" style="display:none;">
                <li><img src="{{asset('images/We.jpg')}}" alt="We" title="We"/>
                </li>
                <li><img src="{{asset('images/are.jpg')}}" alt="are" title="are"/>
                </li>
                <li><img src="{{asset('images/Greentea%20Team.jpg')}}" alt="Greentea Team" title="Greentea Team"/>
                </li>
                <li><img src="{{asset('images/Study.jpg')}}" alt="Study" title="Study"/>
                </li>
                <li><img src="{{asset('images/hard.jpg')}}" alt="hard" title="hard"/>
                </li>
                <li><img src="{{asset('images/Working.jpg')}}" alt="Working" title="Working"/>
                </li>
                <li><img src="{{asset('images/together.jpg')}}" alt="together" title="together"/>
                </li>
                <li><img src="{{asset('images/Endeavour.jpg')}}" alt="Endeavour" title="Endeavour"/>
                </li>
                <li><img src="{{asset('images/to%20be.jpg')}}" alt="to be" title="to be"/>
                </li>
                <li><img src="{{asset('images/WIN.jpg')}}" alt="WIN" title="WIN"/>
                </li>
            </ul>
            <ul class="amazingslider-thumbnails" style="display:none;">
                <li><img src="{{asset('images/We-tn.jpg')}}" alt="We" title="We"/></li>
                <li><img src="{{asset('images/are-tn.jpg')}}" alt="are" title="are"/></li>
                <li><img src="{{asset('images/Greentea%20Team-tn.jpg')}}" alt="Greentea Team" title="Greentea Team"/>
                </li>
                <li><img src="{{asset('images/Study-tn.jpg')}}" alt="Study" title="Study"/></li>
                <li><img src="{{asset('images/hard-tn.jpg')}}" alt="hard" title="hard"/></li>
                <li><img src="{{asset('images/Working-tn.jpg')}}" alt="Working" title="Working"/></li>
                <li><img src="{{asset('images/together-tn.jpg')}}" alt="together" title="together"/></li>
                <li><img src="{{asset('images/Endeavour-tn.jpg')}}" alt="Endeavour" title="Endeavour"/></li>
                <li><img src="{{asset('images/to%20be-tn.jpg')}}" alt="to be" title="to be"/></li>
                <li><img src="{{asset('images/WIN-tn.jpg')}}" alt="WIN" title="WIN"/></li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
                <div class="service-item">
                    ...
                    <div class="service-desc">
                        <h3><a href="iot.html#features">IoT</a></h3>
            ...
            <div class="col-md-4 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="500ms">
                <div class="service-item">
                    ...
                    <div class="service-desc">
                        <h3><a href="sub-index.html">Website</a></h3>
            ...
            <div class="col-md-4 wow fadeInRight" data-wow-duration="500ms" data-wow-delay="900ms">
                <div class="service-item">
                    ...
                    <div class="service-desc">
                        <h3><a href="/sub-index/index.html">AI</a></h3>
                        <p>
    ...
    <div class="project-wrapper">
        <div class="wrapper-all">
            ...
            <figure class="mix work-item branding">
                ...
                <figcaption class="overlay">
                    <a class="fancybox" rel="works" title="Write Your Image Caption Here"
                       href="{{asset('img/works/item-7.jpg')}}"><i
                                class="fa fa-eye fa-lg"></i></a>
                    <h4>Web Store </h4>
                    <p>Website </p>
                </figcaption>
            ...
            <figure class="mix work-item photography">
                ...
                <figcaption class="overlay">
                    <a class="fancybox" rel="works" title="Write Your Image Caption Here"
                       href="{{asset('img/works/item-4.jpg')}}"><i
                                class="fa fa-eye fa-lg"></i></a>
            ...
            <figure class="mix work-item branding">
                ...
                <figcaption class="overlay">
                    <a class="fancybox" rel="works" title="Write Your Image Caption Here"
                       href="{{asset('img/works/item-5.jpg')}}"><i
                                class="fa fa-eye fa-lg"></i></a>
                    <h4>Web Store </h4>
                    <p>Website </p>
                </figcaption>
            ...
            <figure class="mix work-item logo-design">
                ...
                <figcaption class="overlay">
                    <a class="fancybox" rel="works" title="Write Your Image Caption Here"
                       href="{{asset('img/works/item-6.jpg')}}"><i
                                class="fa fa-eye fa-lg"></i></a>
                    <h4>AI</h4>
        ...
        <!--<img src="{{asset('img/works/item-7.jpg')}}" alt="">-->
            <!--<figcaption class="overlay">-->
        <!--<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="{{asset('img/works/item-7.jpg')}}"><i class="fa fa-eye fa-lg"></i></a>-->
            ...
            <!--<figure class="mix work-item photography">-->
        <!--<img src="{{asset('img/works/item-8.jpg')}}" alt="">-->
            <!--<figcaption class="overlay">-->
        <!--<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="{{asset('img/works/item-8.jpg')}}"><i class="fa fa-eye fa-lg"></i></a>-->
            <!--<h4>Labore et dolore magnam</h4>-->
            <!--<p>Photography</p>-->
            <!--</figcaption>-->
            <!--</figure>-->
            ...
            <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated"
                ...
                <div class="member-thumb">
                    ...
                    <figcaption class="overlay">
                        ...
                        <ul class="social-links text-center">
                            <li><a href=""><i class="fa fa-twitter fa-lg"></i></a></li>
                            <li><a href="https://www.facebook.com/bo.bay.94"><i class="fa fa-facebook fa-lg"></i></a>
                            </li>
                            <li><a href=""><i class="fa fa-google-plus fa-lg"></i></a></li>
                        </ul>
                    </figcaption>
            ...
            <figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated"
                ...
                <div class="member-thumb">
                    ...
                    <figcaption class="overlay">
                        ...
                        <ul class="social-links text-center">
                            <li><a href=""><i class="fa fa-twitter fa-lg"></i></a></li>
                            <li><a href="https://www.facebook.com/kingtxx98"><i class="fa fa-facebook fa-lg"></i></a>
                            </li>
                            <li><a href=""><i class="fa fa-google-plus fa-lg"></i></a></li>
                        </ul>
                    </figcaption>
